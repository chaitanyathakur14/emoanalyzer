...
export const HomePage = ({ onNavigate }: HomePageProps) => {
  const features = [
    ...
    {
      id: 'games',
      title: 'EQ Training Games',
      description: 'Interactive games to enhance perception, empathy, and focus',
      icon: Target,
      color: 'bg-pink-500',
  ...
  const stats = [
    { label: 'EQ Score', value: 'Assessment based', icon: Brain, color: 'text-blue-600' },
    { label: 'Sessions', value: '10+ per user', icon: Target, color: 'text-green-600' },
    { label: 'Streak', value: 'On days', icon: TrendingUp, color: 'text-purple-600' },
